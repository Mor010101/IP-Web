...
export class UserService extends BaseService {
  ...
  /**
   * Path part for operation apiUserIstoricMedicalIdPut
   */
  static readonly ApiUserIstoricMedicalIdPutPath = '/api/User/IstoricMedical{id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `apiUserIstoricMedicalIdPut()` instead.
   *
   * This method doesn't expect any request body.
   */
  apiUserIstoricMedicalIdPut$Response(params: {
    id: string;
  ...
  context?: HttpContext
    ...
    const rb = new RequestBuilder(this.rootUrl, UserService.ApiUserIstoricMedicalIdPutPath, 'put');
    if (params) {
      rb.path('id', params.id, {});
      rb.query('istoricMedical', params.istoricMedical, {});
  ...
  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `apiUserIstoricMedicalIdPut$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  apiUserIstoricMedicalIdPut(params: {
    id: string;
    istoricMedical?: string;
    type?: string;
  },
  context?: HttpContext
    ...
    return this.apiUserIstoricMedicalIdPut$Response(params,context).pipe(
      map((r: StrictHttpResponse<void>) => r.body as void)
    );
  }

  /**
   * Path part for operation apiUserIstoricMedicalIdDelete
   */
  static readonly ApiUserIstoricMedicalIdDeletePath = '/api/User/IstoricMedical{id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `apiUserIstoricMedicalIdDelete()` instead.
   *
   * This method doesn't expect any request body.
   */
  apiUserIstoricMedicalIdDelete$Response(params: {
    id: string;
    istoricMedical?: string;
    type?: string;
  },
  context?: HttpContext
    ...
    const rb = new RequestBuilder(this.rootUrl, UserService.ApiUserIstoricMedicalIdDeletePath, 'delete');
    if (params) {
      rb.path('id', params.id, {});
      rb.query('istoricMedical', params.istoricMedical, {});
      rb.query('type', params.type, {});
  ...
  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `apiUserIstoricMedicalIdDelete$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  apiUserIstoricMedicalIdDelete(params: {
    id: string;
    istoricMedical?: string;
    type?: string;
  },
  context?: HttpContext
    ...
    return this.apiUserIstoricMedicalIdDelete$Response(params,context).pipe(
      map((r: StrictHttpResponse<void>) => r.body as void)
    );
  }
